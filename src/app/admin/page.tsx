...
function AdminPageContent() {
  ...
  const [profileType, setProfileType] = useState<"patient" | "doctor">(
    "patient"
  );
  ...
  useEffect(() => {
    const loadAnalytics = async () => {
      try {
        ...
        const [statsData, activityData, distributionData, surveyStatsData] =
          await Promise.all([
  ...
  const handleSaveNewUser = async () => {
    try {
      const newUser = await adminApi.createUser(
        newUserFormData as UserCreateData
      );
  ...
  const filteredUsers = users.filter((u) => {
    ...
    const matchesType =
      selectedUserType === "all" || u.user_type === selectedUserType;
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      ...
      if (profileType === "patient") {
        ...
        newProfile = await adminApi.createPatientProfile(
          profileUser.id,
          patientData
        );
      } else {
        ...
        newProfile = await adminApi.createDoctorProfile(
          profileUser.id,
          doctorData
        );
      }
              ...
              {surveyStats && (
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Satisfacción y recomendaciones de pacientes
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div className="space-y-2">
                          <div className="flex justify-between text-sm">
                            ...
                            <span className="font-medium">
                              {surveyStats.averageRatings.appointmentEase}/5
                            </span>
                          </div>
                          <div className="flex justify-between text-sm">
                            <span>Puntualidad:</span>
                            <span className="font-medium">
                              {surveyStats.averageRatings.punctuality}/5
                            </span>
                          </div>
                          <div className="flex justify-between text-sm">
                            <span>Personal médico:</span>
                            <span className="font-medium">
                              {surveyStats.averageRatings.medicalStaff}/5
                            </span>
                          </div>
                          <div className="flex justify-between text-sm">
                            <span>Plataforma:</span>
                            <span className="font-medium">
                              {surveyStats.averageRatings.platform}/5
                            </span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="space-y-2">
                          <div className="flex justify-between text-sm">
                            ...
                            <span className="font-medium">
                              {surveyStats.recommendations.yes}
                            </span>
                          </div>
                          <div className="flex justify-between text-sm">
                            <span className="text-red-600">No:</span>
                            <span className="font-medium">
                              {surveyStats.recommendations.no}
                            </span>
                          </div>
                          <div className="flex justify-between text-sm">
                            <span className="text-gray-600">Tal vez:</span>
                            <span className="font-medium">
                              {surveyStats.recommendations.maybe}
                            </span>
                          </div>
                        </div>
                      </div>
                ...
                <CardContent>
                  ...
                  <div className="flex flex-col md:flex-row gap-4 mb-6">
                    ...
                    <div className="flex gap-2">
                      <Button
                        variant={
                          selectedUserType === "all" ? "default" : "outline"
                        }
                        size="sm"
                              ...
                              {!user.profile && user.user_type !== "admin" && (
                                <Button
                                  ...
                                  onClick={() =>
                                    handleCreateProfile(
                                      user,
                                      user.user_type as "patient" | "doctor"
                                    )
                                  }
                                >
                ...
                <CardHeader>
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <CardDescription>
                        Todas las encuestas de satisfacción enviadas por
                        pacientes
                      </CardDescription>
                    </div>
                ...
                <CardContent>
                  ...
                  {surveyStats && (
                    <div className="grid gap-4 md:grid-cols-4 mb-6">
                      ...
                      <Card>
                        <CardContent className="p-4 text-center">
                          <div className="text-2xl font-bold text-blue-600">
                            {surveyStats.averageRatings.medicalStaff}
                          </div>
                          <p className="text-xs text-gray-500">
                            Promedio Personal Médico
                          </p>
                        </CardContent>
                      </Card>
                      <Card>
                        <CardContent className="p-4 text-center">
                          <div className="text-2xl font-bold text-green-600">
                            {surveyStats.averageRatings.platform}
                          </div>
                          <p className="text-xs text-gray-500">
                            Promedio Plataforma
                          </p>
                  ...
                  {surveysLoading ? (
                          ...
                          {survey.additional_comments && (
                            <div className="bg-gray-50 p-3 rounded-md">
                              <p className="text-sm text-gray-700 italic">
                                &ldquo;{survey.additional_comments}&rdquo;
                              </p>
                            </div>
                          )}
                        </div>
                    ...
                    <div className="text-center py-8 text-gray-500">
                      ...
                      <p className="text-sm">
                        Las encuestas aparecerán aquí cuando los pacientes las
                        envíen
                      </p>
                    </div>
                  ) : null}
                      ...
                      <div>
                        ...
                        <div className="mt-2 p-3 bg-gray-50 rounded">
                          {viewingUser.user_type === "doctor" && (
                            <>
                              {(viewingUser.profile as DoctorProfile)
                                .specialty && (
                                <p>
                                  <span className="font-medium">
                                    Especialidad:
                          ...
                          {viewingUser.user_type === "patient" && (
                            <>
                              ...
                              {viewingUser.user_type === "patient" &&
                                (viewingUser.profile as PatientProfile)
                                  .address && (
                                  <p>
                                    <span className="font-medium">
                                      Dirección:
            ...
            <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50">
              <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4 max-h-96 overflow-y-auto shadow-xl">
                <div className="flex justify-between items-center mb-4">
                  <h2 className="text-xl font-semibold">
                    Crear Perfil de{" "}
                    {profileType === "patient" ? "Paciente" : "Médico"}
                  </h2>
                  <Button
                    variant="ghost"
                    size="sm"
                ...
                <div className="space-y-4">
                  <div className="text-sm text-gray-600 mb-4">
                    Usuario:{" "}
                    <span className="font-medium">{profileUser.name}</span>
                  </div>
